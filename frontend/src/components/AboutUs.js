...
const teamMembers = [
  { name: 'Cengiz Ziyaeddin',
    image: cengiz,
    desc: 'This is a brief intro about the team member.' },
    // desc: 'It’s been my dream role to become a software developer, and this project has been the best way to conclude a challenging but extremely fun bootcamp at Sigmalabs.\nI have loved iterating, testing and building with the Kitchen Genie team, we have all pushed ourselves to apply our newly learnt knowledge, designing a product that we think tackles the important problem of food waste. I am proud to call it my first software development team project.\nTo the future!' },
  { name: 'Keano Robinson',
    image: keano,
    desc: 'This is a brief intro about the team member.' },
    // desc: 'I am proud to have Kitchen Genie as my first end-to-end web development project, and I am happy that I was able to apply the software engineering skills that I have built over the intensive, 12-week Sigma Labs training course with such a great team. As a chemical engineer turned software engineer, here is the start of my software engineering journey!' },
  { name: 'Rafiul Ansari',
    image: rafiul,
    desc: 'This is a brief intro about the team member.' },
